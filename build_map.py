...
<div class="about">
  ...
  <p>This is a proposal to add wayfinding signs to trail intersections in the forest area
  spanning several parcels across Holliston, Milford, and Hopkinton. The network is
  commonly known as the "Vietnam Trail Network" or the "Upper Charles" trails.</p>
